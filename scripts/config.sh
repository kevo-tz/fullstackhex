...
BENCHLITE_CONCURRENT="${BENCHLITE_CONCURRENT:-20}"

# Performance thresholds (in milliseconds unless otherwise noted)
RUST_HEALTH_P50_THRESHOLD="${RUST_HEALTH_P50_THRESHOLD:-100}"
RUST_HEALTH_P99_THRESHOLD="${RUST_HEALTH_P99_THRESHOLD:-300}"
RUST_HEALTH_DB_P50_THRESHOLD="${RUST_HEALTH_DB_P50_THRESHOLD:-50}"
RUST_HEALTH_DB_P99_THRESHOLD="${RUST_HEALTH_DB_P99_THRESHOLD:-100}"
RUST_HEALTH_REDIS_P50_THRESHOLD="${RUST_HEALTH_REDIS_P50_THRESHOLD:-50}"
RUST_HEALTH_REDIS_P99_THRESHOLD="${RUST_HEALTH_REDIS_P99_THRESHOLD:-100}"
...
export RUST_HEALTH_DB_P50_THRESHOLD
export RUST_HEALTH_DB_P99_THRESHOLD
export RUST_HEALTH_REDIS_P50_THRESHOLD
export RUST_HEALTH_REDIS_P99_THRESHOLD
export RUST_HEALTH_PYTHON_P50_THRESHOLD
export RUST_HEALTH_PYTHON_P99_THRESHOLD
